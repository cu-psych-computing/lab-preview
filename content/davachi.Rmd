...
<div class="video-box">
  <iframe class="responsive-iframe" src="https://drive.google.com/file/d/1u9jEaWREzcYN12QR4YYDOgqtAgwXBHaH/preview"></iframe>
</div>
...
contact <- data.frame(Contact = c("Molly Hermiller"),
                   Role = c("Post-Doc"),
