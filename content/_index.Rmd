...
**Our Lab Preview is scheduled for September 15th, 4:30 - 6:00 pm outside Schermerhorn Hall.**
...
Lab = c("Attention, Perception, and Memory Lab",
...
urls = rep("/aly/",25)) %>%
  mutate(links = paste0("[", Lab, "](", urls, ")"))



labs %>%
  select(Faculty, links) %>%
  kbl() %>%
