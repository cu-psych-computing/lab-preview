...
This website is meant to act as an asynchronous extension of our typical Lab Preview Day. If you can't make it to the official event, feel free to use the recruitment videos, blurbs, and contact info on this website to reach out to labs you're interested in. The webiste will be updated throughout the year as the needs of labs change.
...
```{r, echo = F, warning = F}
library(knitr)
labs <- read_delim("../static/lab-info.txt", delim = "\t") %>%
